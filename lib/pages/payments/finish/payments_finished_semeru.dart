...
class PaymentFinishedSemeru extends StatefulWidget {
  // const PaymentFinishedSemeru({super.key});

  @override
  State<PaymentFinishedSemeru> createState() => _PaymentFinishedSemeruState();
}

class _PaymentFinishedSemeruState extends State<PaymentFinishedSemeru> {
  @override
                        ...
                        return AlertDialog(
                          ...
                          actions: [
                            ElevatedButton(
                                ...
                                //     MaterialPageRoute(
                                //         builder: (context) => PaymentDetailSemeru())),
                                ),
                          ],
                        );
                      });
