...
class PaymentFinishedRanuKumbolo extends StatefulWidget {
  // const PaymentFinishedRanuKumbolo({super.key});

  @override
  State<PaymentFinishedRanuKumbolo> createState() =>
      _PaymentFinishedRanuKumboloState();
}

class _PaymentFinishedRanuKumboloState
    extends State<PaymentFinishedRanuKumbolo> {
  @override
                        ...
                        return AlertDialog(
                          ...
                          actions: [
                            ElevatedButton(
                                ...
                                //     MaterialPageRoute(
                                //         builder: (context) => PaymentDetailRanuKumbolo())),
                                ),
                          ],
                        );
                      });
