...
class PaymentFinishedBromo extends StatefulWidget {
  // const PaymentFinishedBromo({super.key});

  @override
  State<PaymentFinishedBromo> createState() => _PaymentFinishedBromoState();
}

class _PaymentFinishedBromoState extends State<PaymentFinishedBromo> {
  @override
                        ...
                        return AlertDialog(
                          ...
                          actions: [
                            ElevatedButton(
                                ...
                                //     MaterialPageRoute(
                                //         builder: (context) => PaymentDetailBromo())),
                                ),
                          ],
                        );
                      });
