...
class PaymentDetailRanuRegulo extends StatefulWidget {
  // const PaymentDetailRanuRegulo({super.key});

  @override
  State<PaymentDetailRanuRegulo> createState() => _PaymentDetailStateBromo();
}

class _PaymentDetailStateBromo extends State<PaymentDetailRanuRegulo> {
  @override
